...
export default function Landing() {
  ...
  return (
    <div className="min-h-[100dvh] bg-[#f69a19] flex flex-col relative overflow-hidden">
      ...
      <div className="flex-1 bg-white rounded-t-[3rem] shadow-[0_-15px_40px_rgba(0,0,0,0.15)] flex flex-col items-center pt-4 px-6 pb-12 z-10 -mt-[2vh] relative w-full">
        
        {/* Logo */}
        <div className="w-full max-w-xs mb-auto mt-0">
